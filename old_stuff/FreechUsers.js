function FreechUsers(names) {
    this._names = names;
}

FreechUsers.prototype.doStatuses = function (cbfunc, outdatedLimit) {
    ...
    for (var i=0; i<this._names.length; i++) {
        ...
        Freech.getUser(this._names[i]).doStatus(cbfuncIfAllComplete, outdatedLimit);

    }

}

FreechUsers.prototype.doLatestPosts = function (count, cbfunc, outdatedLimit) {
    ...
    var doPostTilCount = function (posts) {
        ...
        if (currentCount < count) {
            ...
            Freech.getUser(posts[latestPostIndex].getUsername())
                .doPost(
